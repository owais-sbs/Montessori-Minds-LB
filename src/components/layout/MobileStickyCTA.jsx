  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-deep-forest/10 bg-white/95 p-3 backdrop-blur-xl pb-[max(0.75rem,env(safe-area-inset-bottom))] md:hidden">
      <div className="mx-auto flex max-w-lg items-center gap-2">
        <Button to={ROUTES.bookATour} variant="primary" className="min-h-[48px] flex-1 !px-4 !py-3">
          Book a visit
        </Button>
        <a
          href={whatsappHref}
          ...
          className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-deep-forest text-white shadow-sm"
        >
          <ChatIcon />
        </a>
      </div>
